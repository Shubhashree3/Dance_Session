  ...
  <div class="main_template" id="dance">
    ...
    <b-container class="dance_container" fluid>
      ...
      <b-row class="d-flex flex-row justify-items-around p-3">
        ...
        <b-col class="">
          <NuxtLink to="session"><b-button class=" float-right" variant="outline-primary" size="lg">View All Users
          </b-button></NuxtLink>
          <b-button class=" float-right mr-2" @click="showModal" variant="outline-primary" size="lg"v-b-modal.modal-prevent-closing>Add Session</b-button>
        </b-col>
        
      </b-row>
      <AdminCard/>
      <b-modal ref="my-modal" id="modal-prevent-closing" hide-footer title="Add Session" header-bg-variant="danger" header-text-variant="light" footer-bg-variant="danger"  >
        <form ref="form" >
          <b-form-group
            label="Id"
            label-for="id-input"
        ...
        <b-button class=" ml-2 mt-3 float-right" variant="outline-primary"  @click="handleAdd">Add</b-button>
